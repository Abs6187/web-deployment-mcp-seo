...
```bash
npx skills add Abs6187/web-deployment-mcp-seo
```
...
- [`EXAMPLES.md`](EXAMPLES.md) — Copy-pasteable configuration templates, WebMCP forms, pure CSS FAQs, and agent prompts.
